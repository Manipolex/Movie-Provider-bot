...
STREAM_SITE = (environ.get('STREAM_SITE', 'pdiskshortener.com'))
STREAM_API = (environ.get('STREAM_API', '65e11465af7a448a1a4fb8b539a52350a9125d27'))
...
# Others
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'pdiskshortener.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '65e11465af7a448a1a4fb8b539a52350a9125d27')
...
URL = "https://sympathetic-isobel-nsmovies77.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://sympathetic-isobel-nsmovies77.koyeb.app/:8000/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://sympathetic-isobel-nsmovies77.koyeb.app/".format(FQDN)
else:
    URL = "http://sympathetic-isobel-nsmovies77.koyeb.app/".format(FQDN)
